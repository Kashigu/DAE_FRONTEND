<template>
  <div class="min-h-screen bg-gray-50 p-8">
    <div class="flex items-center mb-8">
      ...
      <h1 class="text-4xl font-bold text-center flex-grow text-gray-800">Editar Produto</h1>
    </div>
      ...
      <form @submit.prevent="updateProduct">
        ...
        <div class="mb-6">
          ...
          >
            ...
            <option value="BELEZA_E_CUIDADO_PESSOAL">Beleza e Cuidado Pessoal</option>
...
export default {
  setup() {
    ...
    const produtoId = router.currentRoute.value.params.id;
    ...
    const updateProduct = async () => {
      try {
        await api.patch(`/produto/${produtoId}`, produto.value);
